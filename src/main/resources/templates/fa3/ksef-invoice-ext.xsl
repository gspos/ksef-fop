...
<xsl:stylesheet version="2.0"
    ...
    <xsl:include href="invoice-rows-ext.xsl"/>
...
<!--                    Linia oddzielająca-->
                   <fo:block border-bottom="solid 1px grey" space-after="4mm" space-before="4mm"/>
                    ...
                    <!-- Podmioty inne -->
                    <xsl:if test="crd:Podmiot3[not(crd:Rola = 5)]">
                        <!-- Linia oddzielająca -->
                        ...
                        <fo:table table-layout="fixed" width="100%">
                            ...
                            <fo:table-body>
                                ...
                                <xsl:for-each select="crd:Podmiot3[not(crd:Rola = 5)][position() mod 2 = 1]">
                                    <fo:table-row>
                                        <!-- Pierwsza komórka w wierszu -->
                                        <fo:table-cell>
                                            <fo:block font-size="7pt">
                                        ...
                                        <!-- Druga komórka, jeśli istnieje element na następnej pozycji -->
                                        <xsl:choose>
                                            <xsl:when test="following-sibling::crd:Podmiot3[not(crd:Rola = 5)]">
                                                <fo:table-cell>
                                                    <fo:block font-size="7pt">
...
<!--                            </fo:block>-->
                    ...
                    <xsl:if test="crd:Fa/crd:Adnotacje/crd:P_16 = 1 or crd:Fa/crd:Adnotacje/crd:P_17 = 1 or crd:Fa/crd:Adnotacje/crd:P_18 = 1 or crd:Fa/crd:Adnotacje/crd:P_18A = 1 or crd:Fa/crd:Adnotacje/crd:P_23 = 1 or crd:Fa/crd:Adnotacje/crd:Zwolnienie/crd:P_19 = 1 or crd:Fa/crd:Adnotacje/crd:NoweSrodkiTransportu/crd:P_22 = 1 or crd:Fa/crd:Adnotacje/crd:PMarzy/crd:P_PMarzy = 1 or crd:Fa/crd:TP = 1 or crd:Fa/crd:FP = 1">
                       ...
                       <fo:block border-bottom="solid 1px grey" space-after="4mm" space-before="4mm"/>
                        ...
                        <fo:table table-layout="fixed" width="100%" space-after="2mm">
                            ...
                            <fo:table-body>
                                ...
                                <xsl:if test="crd:Fa/crd:Adnotacje/crd:P_23 = 1">
                                    <fo:table-row>
                                        <fo:table-cell number-columns-spanned="2">
                                            <fo:block font-size="7pt" text-align="left">
                                                <fo:inline font-weight="bold"><xsl:value-of select="key('kLabels', 'simplifiedTriangular', $labels)"/></fo:inline>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                </xsl:if>
                                <!-- Zwolnienie z VAT -->
                                <xsl:if test="crd:Fa/crd:Adnotacje/crd:Zwolnienie/crd:P_19 = 1">
                                    <fo:table-row>
                                        <fo:table-cell number-columns-spanned="2">
                                            <fo:block font-size="7pt" text-align="left">
                                                <fo:inline font-weight="bold"><xsl:value-of select="key('kLabels', 'taxExemption', $labels)"/></fo:inline>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                    <xsl:if test="crd:Fa/crd:Adnotacje/crd:Zwolnienie/crd:P_19A or crd:Fa/crd:Adnotacje/crd:Zwolnienie/crd:P_19B or crd:Fa/crd:Adnotacje/crd:Zwolnienie/crd:P_19C">
                                        <fo:table-row>
                                            <fo:table-cell number-columns-spanned="2">
                                                <fo:block font-size="7pt" text-align="left">
                                                    <fo:inline font-weight="600"><xsl:value-of select="key('kLabels', 'taxExemption.basis', $labels)"/>: </fo:inline>
                                                    <xsl:value-of select="crd:Fa/crd:Adnotacje/crd:Zwolnienie/crd:P_19A"/>
                                                    <xsl:value-of select="crd:Fa/crd:Adnotacje/crd:Zwolnienie/crd:P_19B"/>
                                                    <xsl:value-of select="crd:Fa/crd:Adnotacje/crd:Zwolnienie/crd:P_19C"/>
                                                </fo:block>
                                            </fo:table-cell>
                                        </fo:table-row>
                                    </xsl:if>
                                ...
                                <!-- Procedura marży -->
                                <xsl:if test="crd:Fa/crd:Adnotacje/crd:PMarzy/crd:P_PMarzy = 1">
                                    <fo:table-row>
                                        <fo:table-cell number-columns-spanned="2">
                                            <fo:block font-size="7pt" text-align="left">
                                                <fo:inline font-weight="bold">
                                                    <xsl:choose>
                                                        <xsl:when test="crd:Fa/crd:Adnotacje/crd:PMarzy/crd:P_PMarzy_2 = 1">
                                                            <xsl:value-of select="key('kLabels', 'marginProcedure.tourism', $labels)"/>
                                                        </xsl:when>
                                                        <xsl:when test="crd:Fa/crd:Adnotacje/crd:PMarzy/crd:P_PMarzy_3_1 = 1">
                                                            <xsl:value-of select="key('kLabels', 'marginProcedure.usedGoods', $labels)"/>
                                                        </xsl:when>
                                                        <xsl:when test="crd:Fa/crd:Adnotacje/crd:PMarzy/crd:P_PMarzy_3_2 = 1">
                                                            <xsl:value-of select="key('kLabels', 'marginProcedure.art', $labels)"/>
                                                        </xsl:when>
                                                        <xsl:when test="crd:Fa/crd:Adnotacje/crd:PMarzy/crd:P_PMarzy_3_3 = 1">
                                                            <xsl:value-of select="key('kLabels', 'marginProcedure.collectibles', $labels)"/>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            <xsl:value-of select="key('kLabels', 'marginProcedure', $labels)"/>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                                </fo:inline>
                                            </fo:block>
                                ...
                                <xsl:if test="crd:Fa/crd:Adnotacje/crd:NoweSrodkiTransportu/crd:P_22 = 1">
                                    <fo:table-row>
                                        <fo:table-cell number-columns-spanned="2">
                                            <fo:block font-size="7pt" text-align="left">
                                                <fo:inline font-weight="bold"><xsl:value-of select="key('kLabels', 'newTransport', $labels)"/></fo:inline>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                    <xsl:for-each select="crd:Fa/crd:Adnotacje/crd:NoweSrodkiTransportu/crd:NowySrodekTransportu">
                                        <fo:table-row>
                                            <fo:table-cell padding-right="5mm">
                                                <fo:block font-size="7pt" text-align="left">
                                                    <fo:inline font-weight="600"><xsl:value-of select="key('kLabels', 'newTransport.row', $labels)"/>: </fo:inline>
                                                    <xsl:value-of select="crd:P_NrWierszaNST"/>
                                                    <xsl:if test="crd:P_22BMK">
                                                        <xsl:text> | </xsl:text>
                                                        <fo:inline font-weight="600"><xsl:value-of select="key('kLabels', 'newTransport.brand', $labels)"/>: </fo:inline>
                                                        <xsl:value-of select="crd:P_22BMK"/>
                                                    </xsl:if>
                                                    <xsl:if test="crd:P_22BMD">
                                                        <xsl:text> | </xsl:text>
                                                        <fo:inline font-weight="600"><xsl:value-of select="key('kLabels', 'newTransport.model', $labels)"/>: </fo:inline>
                                                        <xsl:value-of select="crd:P_22BMD"/>
                                                    </xsl:if>
                                                    <xsl:if test="crd:P_22BK">
                                                        <xsl:text> | </xsl:text>
                                                        <fo:inline font-weight="600"><xsl:value-of select="key('kLabels', 'newTransport.color', $labels)"/>: </fo:inline>
                                                        <xsl:value-of select="crd:P_22BK"/>
                                                    </xsl:if>
                                                </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding-left="5mm">
                                                <fo:block font-size="7pt" text-align="left">
                                                    <fo:inline font-weight="600"><xsl:value-of select="key('kLabels', 'newTransport.date', $labels)"/>: </fo:inline>
                                                    <xsl:value-of select="crd:P_22A"/>
                                                    <xsl:if test="crd:P_22BNR">
                                                        <xsl:text> | </xsl:text>
                                                        <fo:inline font-weight="600"><xsl:value-of select="key('kLabels', 'newTransport.regNumber', $labels)"/>: </fo:inline>
                                                        <xsl:value-of select="crd:P_22BNR"/>
                                                    </xsl:if>
                                                    <xsl:if test="crd:P_22B">
                                                        <xsl:text> | </xsl:text>
                                                        <fo:inline font-weight="600"><xsl:value-of select="key('kLabels', 'newTransport.mileage', $labels)"/>: </fo:inline>
                                                        <xsl:value-of select="crd:P_22B"/>
                                                    </xsl:if>
                                                    <xsl:if test="crd:P_22C or crd:P_22D">
                                                        <xsl:text> | </xsl:text>
                                                        <fo:inline font-weight="600"><xsl:value-of select="key('kLabels', 'newTransport.engineHours', $labels)"/>: </fo:inline>
                                                        <xsl:value-of select="crd:P_22C"/><xsl:value-of select="crd:P_22D"/>
                                                    </xsl:if>
                                                </fo:block>
                                            </fo:table-cell>
                                        </fo:table-row>
                                ...
                                <xsl:if test="crd:Fa/crd:TP = 1">
                                    <fo:table-row>
                                        <fo:table-cell number-columns-spanned="2">
                                            <fo:block font-size="7pt" text-align="left">
                                                <fo:inline font-weight="bold"><xsl:value-of select="key('kLabels', 'tp', $labels)"/></fo:inline>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                </xsl:if>
                                <!-- FP - faktura do paragonu -->
                                <xsl:if test="crd:Fa/crd:FP = 1">
                                    <fo:table-row>
                                        <fo:table-cell number-columns-spanned="2">
                                            <fo:block font-size="7pt" text-align="left">
                                                <fo:inline font-weight="bold"><xsl:value-of select="key('kLabels', 'fp', $labels)"/></fo:inline>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                </xsl:if>
            ...
            <xsl:otherwise>
                <fo:block font-weight="bold" font-size="12pt" text-align="left" padding-bottom="8px" padding-top="5mm">
                    ...
                    <xsl:if test="crd:RolaInna">
                        <xsl:value-of select="key('kLabels', 'role.other', $labels)"/>
                        <xsl:if test="crd:OpisRoli">
                            <xsl:text> - </xsl:text><xsl:value-of select="crd:OpisRoli"/>
                        </xsl:if>
                    </xsl:if>
                </fo:block>
            </xsl:otherwise>
